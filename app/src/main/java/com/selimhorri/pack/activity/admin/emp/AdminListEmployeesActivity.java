...
public class AdminListEmployeesActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.adminAccountInfo:
                super.startActivity(new Intent(AdminListEmployeesActivity.this, AdminInfoActivity.class));
                return true;
            case R.id.adminLogout:
                super.getSharedPreferences("admin", MODE_PRIVATE)
                        ...
                        .clear()
                        .apply();
                super.startActivity(new Intent(AdminListEmployeesActivity.this, HomeActivity.class));
                return true;
            default:

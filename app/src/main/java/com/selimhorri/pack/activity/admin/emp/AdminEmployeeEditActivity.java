...
public class AdminEmployeeEditActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.adminAccountInfo:
                super.startActivity(new Intent(AdminEmployeeEditActivity.this, AdminInfoActivity.class));
                return true;
            case R.id.adminNewDepartment:
                super.startActivity(new Intent(AdminEmployeeEditActivity.this, AdminEmployeeAddActivity.class));
                return true;
            ...
            case R.id.adminLogout:
                super.getSharedPreferences("admin", MODE_PRIVATE)
                        ...
                        .clear()
                        .apply();
                super.startActivity(new Intent(AdminEmployeeEditActivity.this, HomeActivity.class));
                return true;
            default:
